...
def Level_2(god=role.god.baseGod.God()):
    pygame.init()
    size = (windows_width, windows_height)
    screen = pygame.display.set_mode(size)
    pygame.display.set_caption('第2关')
    ...
    combat_background = pygame.image.load('Image/background/combat_background2.jpg')
    ...
    boss_attack_judge = 0
    enemy_come = [True, True, True, True, True, True, True, True, True]
    ...
    def boss_come():
        ...
        if boss_come_judge == True and len(enemy_list) == 0:
            boss_list.append(
                role.enemy.boss.Boss(name="level2_1", life=80, speed=[-5, 0]))  # boss出现
